...
distributed = False
load_from = None #None #
finetune_from = None #'./logs/polyline-fpn-10/ckpt/best.pth'        #None
log_dir = './logs'
view = False
number_lanes = 12
...
heads = dict(
    ...
    row_tr_heads=12,  # parameter for transformer ?
    row_tr_dim_head=8,
    row_tr_mlp_dim=144,
    row_tr_dropout=0.,
...
### Setting Here ###
dataset_path = './data/LaserLane/All'            # './../All' # 'All-ordered' means with ordered anchor; 'All' means ordered without anchor
